...
public class TestCache {
	  ...
	  public static void main(String[] args) throws InterruptedException {
	        ...
	        TestCache crunchifyCache = new TestCache();
	   ...
	   /*   System.out.println("\n\n==========Test1: crunchifyTestAddRemoveObjects ==========");
	    ...
	    private List<Headline> getNewsAPIResponse() {
	    	
	    	System.out.println("\n\n==========NEWS API Response ==========");
	        
	        HeadlinesController hc = new HeadlinesController();
	        
	        NewsAPIResponse nr = hc.getNewResponse();
	      
	        return nr.getArticles();
	}
